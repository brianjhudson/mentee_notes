...
console.log(
  replaceWordManually("Brian was fighting with Jonathan", "Jonathan")
);
console.log(
  replaceWordManually("Brian was fighting with jonathan", "Jonathan")
);
...
console.log(
  "Replace fancy case sensitive",
  replaceFancy("Brian was fighting Jonathan", "Jonathan")
);
console.log(
  "Replace fancy case insensitive",
  replaceFancy("Brian was fighting jonathan", "Jonathan")
);
